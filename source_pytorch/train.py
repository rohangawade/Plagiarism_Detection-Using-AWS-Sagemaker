...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--input_features',type=int, metavar='IN',
                        help='input batch size for training (default: 3)')
    parser.add_argument('--hidden_dim',type=int,metavar='H',
                        help='hidden size for training (default: 20)')
    parser.add_argument('--output_dim',type=int,metavar='O',
                        help='output size for training (default: 1)')
